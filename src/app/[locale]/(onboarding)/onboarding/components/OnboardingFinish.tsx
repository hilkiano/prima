...
import { Box, BoxProps, Button, Text, useMantineTheme } from "@mantine/core";
import { useMediaQuery } from "@mantine/hooks";
import { useTranslations } from "next-intl";
import React from "react";

type TOnboardingFinish = {};

const FinishSvg = (props: React.ComponentPropsWithoutRef<"svg">) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      data-name="Layer 1"
      width={props ? props.width : "680.83858"}
      height={props ? props.height : "584.23207"}
      viewBox="0 0 680.83858 584.23207"
      xmlnsXlink="http://www.w3.org/1999/xlink"
    >
      <path
        id="b9ccae5a-ffdd-4f5c-9c1e-05af9f0f3372-713"
        data-name="Path 438"
      ...
      />
      <path
        id="f4ad1d06-bd03-4ced-a5c4-c19a65ab4ee5-714"
        data-name="Path 439"
      ...
      />
      <path
        id="baf785f8-b4c6-42cf-85bd-8a16037845f7-715"
        data-name="Path 442"
      ...
      />
      <path
        id="a14e4330-7125-4e03-a856-d6453c34f6cc-716"
        data-name="Path 443"
      ...
      />
      <path
        id="ac20a106-7eb8-4a45-8835-674ef3bf3222-717"
        data-name="Path 141"
      ...
      />
      <path
        id="a8878079-c7cd-406f-a434-8b15b914b9b4-718"
        data-name="Path 141"
      ...
      />
      <path
        id="af64f961-e9a2-4c53-a333-5060c7f850d2-719"
        data-name="Path 142"
      ...
      />
      <path
        id="baad4cfb-158d-4439-9cc3-22475bf47b22-720"
        data-name="Path 143"
      ...
      />
      <path
        id="f3456279-91e5-49ad-aa43-9838b26fb6ca-721"
        data-name="Path 142"
      ...
      />
      <path
        id="a3288adf-49f8-485f-8ae9-1e4f1a13d849-722"
        data-name="Path 143"
      ...
      />
      <path
        id="e63a5b48-5a7d-40a2-b9b0-6adec326348a-723"
        data-name="Path 142"
      ...
      />
      <path
        id="a1c669b4-dfc3-4cfa-a7be-66b71399844d-724"
        data-name="Path 143"
      ...
      />
      <path
        id="bfec50d1-ffb1-4de6-a9ef-a1085e40e016-725"
        data-name="Path 142"
      ...
      />
      <path
        id="bc9696ec-ec99-41d5-9116-3ad9737a38ac-726"
        data-name="Path 143"
...
const OnboardingFinish = React.forwardRef<
  HTMLDivElement,
  TOnboardingFinish & BoxProps
>(({ ...props }, ref) => {
  ...
  return (
    <Box {...props}>
      <FinishSvg width={isMobile ? 200 : 400} height={isMobile ? 200 : 400} />
      <Text variant="gradient" className="text-3xl md:text-5xl mb-1 font-bold">
        {t("Finish.head")}
      </Text>
...
OnboardingFinish.displayName = "OnboardingFinish";
